...
| [P07B — U6 standalone residue](prompts/P07-U6-STANDALONE-CONTRACT.md) | U6c umbrella | A1 source/process and A2.1 compilation-authority units are sealed; A2.2 compiler, B publication/materialization, and C execution remain ordered independent units | no subunit advances until its own commit is sealed and strict exits 0 |
...
| [P07B-A2.2 — recoverable compiler](prompts/P07B-A2-2-RECOVERABLE-COMPILER.md) | U6c/A2.2 | pure deterministic compiler, strict recoverable six-file ContractBundle, fixed Node-core second implementation, manifest bootstrap, explicit ceiling proof, and shared Go/Node semantic corpus; no residue publication or product materializer | cross-root/process byte identity, six-file recovery, tamper refusal, strict parser corpus, Go/Node parity, generated CLI/HTTP smoke, overflow boundaries, bounded fuzzing, race/vet, architecture selftest, and black-box/property closure; source-rewrite design remains `UNRECEIPTED` |
| [P07B-B — terminal publication/materialization](prompts/P07B-B-TERMINAL-PUBLICATION.md) | U6c/B | opaque current-ruling transition, durable terminal ContractBundle residue, full predecessor-chain restart reconstruction, and retryable exact six-file native materialization; no target or execution | full-token CAS-before-publication, restart/corruption/race closure, exclusive no-follow create-new publication, exact-existing inode preservation, post-residue retry, fault matrix, architecture selftest, race/vet, and cumulative verification |
