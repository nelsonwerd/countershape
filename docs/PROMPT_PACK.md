...
| [P07B — U6 standalone residue](prompts/P07-U6-STANDALONE-CONTRACT.md) | U6c umbrella | A1 source/process substrate is sealed; A2 compilation, B publication/materialization, and C execution remain ordered independent units | no subunit advances until its own commit is sealed and strict exits 0 |
