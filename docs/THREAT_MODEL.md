...
- **Status:** design contract; P07B-C through C4P is sealed and strict-clean, C4 CLI-profile physical execution/classification is active and `UNRECEIPTED`, and no security control is validated beyond its exact command/environment receipt
