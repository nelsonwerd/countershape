...
| U6c / P07B-C | capability-only nonhead execution target, target-inventory absence, finalized run, and nonhead execution result | generic executable, copied/parsed target, dirty worktree, reused attempt, runtime substitution, forbidden dependency, Countershape presence, contradiction/ineligibility collapse, execution head advance |
