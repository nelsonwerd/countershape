...
- **Status:** controlling design; P07B-C through C3PB is sealed and strict-clean; C3A cumulative-admission maintenance is active and `UNRECEIPTED`, while official target, physical execution, and product surfaces remain future
...
| U6c / P07B-C | C0 authority plus sealed C1/C1B inert canonical algebra, sealed C2/C2B typed nonhead persistence, sealed C3P/C3PB boot-profile semantics and source receipt, plus active C3A predecessor-admission repair; later official-target, physical run, five-domain scope, and classification publication | C1/C2/C3P grades enter tracked authority only through their separate receipt descendants; C3A must close before frozen C3 resumes, and C3/C3B before C4; runtime/process/semantic publication remain separate, the interlock has no result authority, and study head remains terminal residue |
