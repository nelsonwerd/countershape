...
- **Status:** controlling design; U1–U6, P07A, every P07B-A/B boundary, both P07B-C C0 boundaries, C1 inert source, and C1B receipt reconciliation commit `46c48507fe998ea04e121470d6aa8ba0b38b3dae` are sealed and strict-clean; C2's private persistence substrate is active and `UNRECEIPTED`, while official target, physical execution, and product surfaces remain future
...
| U6c / P07B-C | C0 authority plus sealed C1/C1B inert canonical algebra; active C2 typed nonhead persistence, private evidence, and receipt-backed interlock substrate; later official-target, physical run, five-domain scope, and classification publication | tracked C1 grades require a separately sealed C1B receipt reconciliation; C2 remains `UNRECEIPTED` through its exact 26-path source seal and separately sealed three-path C2B reconciliation; C3–C6 runtime/process/semantic publication remain separate, the interlock has no result authority, and study head remains terminal residue |
