...
- **Status:** controlling design; P07B-C through C3L is sealed and strict-clean; C3F B future-surface admission maintenance is active and `UNRECEIPTED`, while official target, physical execution, and product surfaces remain future
...
| U6c / P07B-C | C0 authority plus sealed C1/C1B inert canonical algebra, sealed C2/C2B typed nonhead persistence, sealed C3P/C3PB boot-profile semantics and source receipt, sealed C3A/C3L admission repairs, plus active C3F B future-surface repair; later official-target, physical run, five-domain scope, and classification publication | C1/C2/C3P grades enter tracked authority only through their separate receipt descendants; C3F must close before frozen C3 resumes, and C3/C3B before C4; runtime/process/semantic publication remain separate, the interlock has no result authority, and study head remains terminal residue |
