...
- **Status:** controlling design; P07B-C through C2B is sealed and strict-clean; C3P is the active pre-C3 boot-session semantic prerequisite and remains `UNRECEIPTED`, while official target, physical execution, and product surfaces remain future
...
| U6c / P07B-C | C0 authority plus sealed C1/C1B inert canonical algebra and sealed C2/C2B typed nonhead persistence, private evidence, and receipt-backed interlock substrate; active C3P boot-profile correction; later official-target, physical run, five-domain scope, and classification publication | C1 and C2 grades enter tracked authority only through their separately sealed receipt descendants; C3P/C3PB must close before C3, and C3/C3B before C4; runtime/process/semantic publication remain separate, the interlock has no result authority, and study head remains terminal residue |
