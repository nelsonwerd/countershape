...
- **Status:** controlling design; U1–U6, P07A, P07B-A1, P07B-A2.1, accepted P07B-A2.2, and sealed P07B-B source receipts are enumerated without reinterpretation in their status files; P07B-B receipt reconciliation is the current closure boundary, while target, execution, and product surfaces remain future
...
| U6c / P07B-B | opaque node-issued terminal publication, complete predecessor restart, and retryable exact native six-file materialization | source sealed at `eb06bdcf18f8e14db1257e73733afdc05cac045e`; receipt-doc closure current; no target-inventory, runtime, run, classification, or product claim |
| U6c / P07B-C | capability-only target, typed nonhead publication, intent-only at-most-once spawn admission, bounded finalized run, five-domain scope closure, and immutable classifier-profile-bound execution | C0 design is locked; runtime remains future until C1–C6 independently seal their semantic, store, target, lifecycle, scope, and classification gates |
