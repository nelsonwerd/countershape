...
- **Status:** controlling design; U1–U6 receipts are enumerated without reinterpretation in `status/U1.md` through `status/U6.md`; P07A portable selected-field ruling authority is sealed at the source boundary recorded in `status/P07A-RULING.md`; P07B standalone source, residue, and execution remain unimplemented
