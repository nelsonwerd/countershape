...
- **Status:** controlling design; P07B-C through C3S is sealed and strict-clean; C3 exact-target publication is active and `UNRECEIPTED`, while physical execution, classification, and product surfaces remain future
...
| U6c / P07B-C | C0 authority plus sealed C1/C1B inert canonical algebra, sealed C2/C2B typed nonhead persistence, sealed C3P/C3PB boot-profile semantics and source receipt, sealed C3A/C3L admission repairs, sealed C3F B future-surface admission, plus active C3 exact pre-spawn target publication; physical run, five-domain scope, and classification publication remain later | C1/C2/C3P grades enter tracked authority only through their separate receipt descendants; C3/C3B must close before C4; runtime/process/semantic publication remain separate, the interlock has no result authority, and study head remains terminal residue |
