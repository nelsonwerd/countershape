...
**Active U7S source-candidate snapshot:** exact sealed U7Q commit `861e2a97fc94e54a88a8aca172c55067972d3acb`, tree `69c306aae604bc51590c2e8d7ddbbd7d7259d4cc`, is the direct parent. U7S is the exact 15-path `SOURCE_FULL` zero-product control candidate with subject `fix: align U7 source study environment authority`, product authority `NONE`, behavior `INHERITED_UNREPROVEN`, 13 `UNRECEIPTED` claims, and U7D receipt `ABSENT`. It repairs only the future U7R validators' omission of the sealed study harness's exact subject `PATH=/usr/bin:/bin:/opt/homebrew/bin` when reconstructing source process-environment digests; it creates no product, study, receipt, semantic, resource, security, deployment, or grade authority. Sealed U7D, sealed U7Q, their evidence, and the U7D source runtime digest remain immutable with bounded milestone `LOCAL_TWO_DOMAIN_PROCESS_ARTIFACT_GREEN_CLI_OFFICIAL_EXECUTION_HTTP_DIRECT_PROCESS_ONLY_FULL_STUDY_RESOURCE_UNRECEIPTED`. Only separately sealed U7R, as a direct child of U7S through U7Q to source U7D, may reconcile that source receipt.
