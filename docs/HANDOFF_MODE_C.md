...
- **CLI precedence:** three green-test candidates disagree on absent vs empty vs explicit-clear values across argv/env/config.
...
8. Produce final strict and HTML didrun reports, exact receipt map, kill ledger, and human tail.
