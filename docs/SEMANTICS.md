...
- **Status:** controlling model; runtime authority is receipted through P07B-B and P07B-C through C2B is sealed and strict-clean; C3P is the active pre-C3 semantic prerequisite and remains `UNRECEIPTED`
