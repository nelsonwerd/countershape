...
- **Status:** controlling model; runtime authority is receipted through P07B-B and P07B-C through C4P is sealed and strict-clean; C4 CLI-profile physical execution/classification is active and remains `UNRECEIPTED`
- **Historical C3 checkpoint:** C3 exact-target publication is active describes the earlier unreceipted checkpoint; C3 is now sealed and C4 is current.
