...
export const REVIEWED_U2_MUTANT_CONTRACT = Object.freeze([
  ...
  Object.freeze({
    ...
    find: "\t\tPath:        invocation.executable, // MUTANT_U2_SPAWN_THROUGH_SHELL",
    replace: "\t\tPath:        \"/bin/sh\", // MUTANT_U2_SPAWN_THROUGH_SHELL",
    package: "./internal/processmechanics",
    testName: "TestPreparedProcessStartsOnceAndClosesWithParentObservedFacts",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    file: "internal/processmechanics/process_darwin.go",
    find: "stderr := newCappedCapture(stderrLimit, overflowC) // MUTANT_U2_SHARE_OUTPUT_CAP",
    replace: "stderr := newCappedCapture(stdoutLimit, overflowC) // MUTANT_U2_SHARE_OUTPUT_CAP",
    package: "./internal/processmechanics",
  ...
  Object.freeze({
    ...
    package: "./internal/processmechanics",
    testName: "TestSimultaneousChannelOverflowRetainsIndependentFacts",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    package: "./internal/processmechanics",
    testName: "TestStdoutAndStderrHaveIndependentExactCaps",
  }),
  Object.freeze({
    ...
    package: "./internal/processmechanics",
    testName: "TestPreTermRetryNeverUsesPostDeadlineProbeAsSignalAuthority",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    find: "const EscapeExclusion = \"PROCESS_GROUP_OR_SESSION_ESCAPE_EXCLUDED_FROM_CONTAINMENT_CLAIM\" // MUTANT_U2_CLAIM_PROCESS_ESCAPE_CONTAINMENT",
    replace: "const EscapeExclusion = \"PROCESS_GROUP_OR_SESSION_ESCAPE_CONTAINED\" // MUTANT_U2_CLAIM_PROCESS_ESCAPE_CONTAINMENT",
    package: "./internal/world",
...
export function assertU2MutantDefinitionSet(
  ...
  for (const mutant of mutants) {
    ...
    if (!/^\.\/internal\/(?:gitobj|processmechanics|world)$/u.test(mutant.package)) {
