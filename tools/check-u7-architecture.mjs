...
const u7qExactPaths = Object.freeze([
	...
	"docs/VERIFICATION.md", "docs/prompts/P08-U7-CLI-REFERENCE-STUDIES.md", "docs/status/U7Q-RECEIPT-TRANSITION-ALIGNMENT.md",
...
function validateSpecificationSurface(value) {
	...
	if (u7q.subject !== "fix: reconcile U7 receipt transition controls" || u7q.final_root !== ".countershape/u7q-final" ||
