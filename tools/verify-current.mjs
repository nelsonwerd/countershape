...
export const exactU7PhaseContracts = Object.freeze({
	...
	U7Q: Object.freeze({ boundary: "U7Q", parent: "U7D", profile: "SOURCE_FULL", state: "SOURCE_CANDIDATE", receipt: "ABSENT", productAuthority: "NONE", productBehavior: "INHERITED_UNREPROVEN" }),
	U7S: Object.freeze({ boundary: "U7S", parent: "U7Q", profile: "SOURCE_FULL", state: "SOURCE_CANDIDATE", receipt: "ABSENT", productAuthority: "NONE", productBehavior: "INHERITED_UNREPROVEN" }),
});
const exactU7GovernedCounts = Object.freeze({ U7P: 0, U7M: 0, U7A: 10, U7B: 19, U7N: 19, U7C: 30, U7D: 34, U7Q: 34, U7S: 34 });
const u7ArchitectureCaseDigest = "6d038f94d4099de1469b281b1d3743fccfc70000564bfd512d2094caa60fa8cf";
...
export function exactU7ArchitectureSelftestOutput(phase) {
	...
	return `U7 architecture defensive self-test passed: active=${phase} cases=118 clean=10 hostile=108 digest=${u7ArchitectureCaseDigest}\n`;
}
